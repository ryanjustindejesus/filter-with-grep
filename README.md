...
In this task, I navigated to the /home/analyst/logs directory and reported on the error messages in the server_logs.txt file.
 <br /> <br />
(1) First, I used the command "cd logs" to navigate to the logs directory. <br/>
...
<br /> <br />
 ...
 <br />  <br />
(1) First, I used the command "cd /home/analyst/reports/users" to navigate to the users directory. <br/>
(2) Then, I used the command "ls | grep Q1" to pipe the output of the ls command to the grep command to list only the files containing the string Q1 in their names. <br/>
...
In this task, I searched for information contained in user files and reported on users that were added and deleted from the system.
 <br /> <br/>
(1) First, I used the command "cd /home/analyst/reports/user" to display the files in the /home/analyst/reports/users directory. <br/>
(2) Then, I used the command "grep jhill Q2_deleted_users.txt" to search the Q2_deleted_users.txt file for the username jhill. <br/>
